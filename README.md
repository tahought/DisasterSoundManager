...
**【収音ユニットの外観】** <img src="public/images/unit_hardware.png" width="400" alt="収音部ユニットの外観">
...
<img src="public/images/map_view.png" width="500" alt="リアルタイムマップの様子">

### 2. 音響イベントのタイムライン（Event Feed）

検知された音の種類（叫び声、崩落音、サイレン等）を時系列でフィード表示します。「どこで、いつ、何が起きたか」をテキストとマップの両面から即座に把握可能です。

<img src="public/images/event_feed.png" width="500" alt="イベントフィード画面">

### 3. デバイスのリモート設定管理

ダッシュボードから各ユニットの名称、設置場所、感度（しきい値）を直接変更できます。Supabaseの実装により、変更内容は瞬時に全管理画面へ同期されます。

<img src="public/images/settings_view.png" width="500" alt="設定管理画面">

### 4. シミュレーション機能 (Demo Panel)

DCONでのデモンストレーションや運用訓練を想定し、仮想の音響イベントを発生させる機能を搭載。システムの挙動を即座に確認可能です。

<img src="public/images/demo_panel.png" width="500" alt="デモパネルの操作">
...
* **開発体制**: 個人開発
* **開発期間**: 2026.01.15 ~ 2026.02.24 (約7時間)
...
* **実機との通信**: 現在のシミュレーション方式から、実機デバイスからのデータ送信・表示への完全移行。
* **AIによる音響解析の高度化**: 実際の環境音を学習させたエッジAIモデルとのAPI連携を深化。
* **プッシュ通知・音声合成**: ブラウザを閉じていても異常を通知する機能や、音声による状況読み上げの実装。
* **モバイル対応の強化**: 現場の救助隊員が手元で確認できるレスポンシブUIの最適化。